 ...
 * WidgetGalleryPage
 * 
 * Browse and add widgets to dashboard.
...
export const WidgetGalleryPage: React.FC = () => {
    ...
    if (!hasAdminAccess && totalVisibleWidgets === 0 && !searchTerm) {
        return (
            <SettingsPage
                ...
                description="Browse and add widgets to your dashboard"
            >
                <EmptyState
                    icon={Share2}
                    message="No widgets have been shared with you yet. Contact your administrator to get access to integration widgets."
                />
            </SettingsPage>
        );
    }
    ...
    return (
        <>
            ...
            >
                {/* Widgets Section */}
                <SettingsSection title="Available Widgets" icon={Search}>
                    {/* Filters */}
