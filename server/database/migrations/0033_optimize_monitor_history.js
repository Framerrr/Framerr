...
module.exports = {
    ...
    up(db) {
        ...
        logger.debug(`[Migration 0033] Pruned ${result.changes} old history rows (keeping 48h)`);
        ...
        logger.debug('[Migration 0033] Dropped redundant indexes (composite index retained)');
    },
